<template>
  <div class="fans-page" ref="scrollRef" @scroll="handleScroll">
    ...
    <el-empty
        ...
        description="这里空空的，发布「帖子」，吸引「粉丝」吧"
    />
...
import {listMyFans, removeFansUser} from "@/api/userApi.ts";
...
const loadFollowingList = async () => {
  ...
  try {
    ...
    const res = await listMyFans(cursor.value, offset.value)
