    ...
    <div class="exchange-card">
      ...
      <div class="exchange-input">
        ...
        <el-input-number
            ...
            placeholder="输入兑换的质子数"
            :disabled="user.proton <= 0"
        />
      ...
      <el-button
          ...
          :loading="loading"
          :disabled="exchangeValue <= 0 || user.proton <= 0"
      >
        立即升级
      </el-button>
...
import {buyEXP, me} from "@/api/userApi.ts";
...
.assets-page {
  ...
  padding: 32px;
  background:
      radial-gradient(circle at top left, #f4f7ff 0%, transparent 30%),
